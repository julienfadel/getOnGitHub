...
/**
 * Classe qui permet de créer et d'afficher le fou.
...
public class Fou extends Piece {
     ...
     */
    public Fou(Context context, boolean couleur, int cote) {
        super(context, cote);
        this.blanc = couleur;
        chercherImage();
    }
    ...
    private void chercherImage() {
        if (blanc) {
            ...
            setImageResource(R.drawable.blanc_fou);

        } else {
            setImageResource(R.drawable.noir_fou);
        }
    }
}
